...
import uhd_bpsk_loopback_epy_block_1_1_0_0_0 as epy_block_1_1_0_0_0  # embedded python block
...
class uhd_bpsk_loopback(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "BPSK Loopback", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("BPSK Loopback")
        ...
        self.settings = Qt.QSettings("GNU Radio", "uhd_bpsk_loopback")
        ...
        self.qtgui_time_sink_x_0_0.set_trigger_mode(qtgui.TRIG_MODE_NORM, qtgui.TRIG_SLOPE_POS, 0.1, 0, 0, "")
        ...
        self.epy_block_1_1_0_0_0 = epy_block_1_1_0_0_0.blk(display_value=True)
        self.epy_block_1_1_0 = epy_block_1_1_0.blk(usrp=0)
        self.epy_block_1_1 = epy_block_1_1.blk(usrp=0)
        self.epy_block_1 = epy_block_1.blk(delay=5)
        ...
        self.msg_connect((self.epy_block_1_1_0_0_0, 'time_est'), (self.epy_block_1_1_0, 'corr_est_in'))
        ...
        self.connect((self.epy_block_1_1, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.epy_block_1_1_0_0_0, 0), (self.blocks_null_sink_1, 0))
        self.connect((self.packet_rx_0, 0), (self.epy_block_1_1_0, 0))
        self.connect((self.packet_rx_0, 3), (self.epy_block_1_1_0_0_0, 0))
