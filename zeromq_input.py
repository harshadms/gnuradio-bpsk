...
class zeromq_input(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "zeromq_input")
        ...
        self.zeromq_push_msg_sink_0 = zeromq.push_msg_sink('tcp://127.0.0.1:1234', 100, True)
...
def main(top_block_cls=zeromq_input, options=None):
