...
class tx_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_filter = rrc_filter = firdes.root_raised_cosine(1.0, sps,1, 0.35, 45)
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(1, rrc_filter)
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_filter(firdes.root_raised_cosine(1.0, self.sps, 1, 0.35, 45))
        self.set_rrc_taps_0(firdes.root_raised_cosine(1, self.sps, 1, self.excess_bw, 45))
    ...
    def set_rrc_filter(self, rrc_filter):
        ...
        self.fir_filter_xxx_0.set_taps(self.rrc_filter)
